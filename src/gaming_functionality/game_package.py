...
async def game_rsvp(ctx, decision, bot):
    ...
    json_file = open('src/gaming_functionality/gamingdata.json', 'r')
    ...
    json_file = open('src/gaming_functionality/gamingdata.json', 'w')
...
async def game_send(ctx, game):
    ...
    file = open("src/gaming_functionality/gamingdata.json" , 'w')
    json.dump(data, file)
    file.close()
    print(data)
...
async def game_list(message, annoy, bot):
    ...
    gamers = open("src/gaming_functionality/gamingdata.json", "r")
